...
export function getScenarioPresets(facilities: Facility[]): Scenario[] {
  ...
  const scenario1: Scenario = {
    ...
    redForce: {
      ...
      airWaves: [
        { id: 'w1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 120, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 90, formation: 'dispersed' },
        { id: 'w2', launchTimeMinutes: 15, droneSpec: 'shahed-136', count: 80, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 110, formation: 'concentrated' },
      ],
      seaLaunchedWaves: [],
  ...
  const scenario2: Scenario = {
    ...
    redForce: {
      ...
      quarantineFormation: 'arc',
      airWaves: [
        { id: 'w1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 300, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 90, formation: 'dispersed' },
        { id: 'w2', launchTimeMinutes: 15, droneSpec: 'shahed-136', count: 200, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 110, formation: 'concentrated' },
      ],
      seaLaunchedWaves: [],
      uuvDeployment: { count: 0, mineTargets: [] },
      strategy: 'saturation_rush',
  ...
  const scenario3: Scenario = {
    ...
    redForce: {
      ...
      quarantineFormation: 'arc',
      airWaves: [
        { id: 'w1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 400, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 85, formation: 'dispersed' },
        { id: 'w2', launchTimeMinutes: 10, droneSpec: 'shahed-136', count: 250, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 105, formation: 'dispersed' },
  ...
  const scenario4: Scenario = {
    ...
    redForce: {
      ...
      airWaves: [
        ...
        { id: 'feint-1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 200, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 110, formation: 'dispersed' },
        ...
        { id: 'main-1', launchTimeMinutes: 40, droneSpec: 'shahed-136', count: 600, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 85, formation: 'concentrated' },
        { id: 'main-2', launchTimeMinutes: 50, droneSpec: 'shahed-136', count: 500, origin: [119.1, 24.8], target: 'tsmc-hsinchu-hq', approachBearing: 75, formation: 'dispersed' },
        { id: 'main-3', launchTimeMinutes: 65, droneSpec: 'shahed-136', count: 450, origin: [119.5, 24.2], target: 'tsmc-hsinchu-hq', approachBearing: 100, formation: 'dispersed' },
      ],
      seaLaunchedWaves: [],
      uuvDeployment: { count: 0, mineTargets: [] },
  ...
  const scenario5: Scenario = {
    ...
    redForce: {
      ...
      airWaves: [
        ...
        { id: 'a1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 250, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 88, formation: 'dispersed' },
        { id: 'a2', launchTimeMinutes: 30, droneSpec: 'shahed-136', count: 200, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 105, formation: 'dispersed' },
        ...
        { id: 'a4', launchTimeMinutes: 90, droneSpec: 'shahed-136', count: 250, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 80, formation: 'dispersed' },
        { id: 'a5', launchTimeMinutes: 120, droneSpec: 'shahed-136', count: 200, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 110, formation: 'line' },
        ...
        { id: 'a7', launchTimeMinutes: 180, droneSpec: 'shahed-136', count: 300, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 92, formation: 'concentrated' },
        { id: 'a8', launchTimeMinutes: 240, droneSpec: 'shahed-136', count: 250, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 108, formation: 'dispersed' },
        ...
        { id: 'a10', launchTimeMinutes: 360, droneSpec: 'shahed-136', count: 350, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 85, formation: 'concentrated' },
        { id: 'a11', launchTimeMinutes: 480, droneSpec: 'shahed-136', count: 250, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 112, formation: 'dispersed' },
  ...
  const scenario6: Scenario = {
    ...
    redForce: {
      conventionalStrikes: [
        ...
        { type: 'cruise_missile', side: 'red', launchTimeMinutes: 5, targetType: 'tsmc-hsinchu-hq', count: 6, pkill: 0.5 },
      ],
      vessels: [
      ...
      quarantineFormation: 'arc',
      airWaves: [
        { id: 'w1', launchTimeMinutes: 15, droneSpec: 'shahed-136', count: 600, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 88, formation: 'dispersed' },
        { id: 'w2', launchTimeMinutes: 25, droneSpec: 'shahed-136', count: 400, origin: FUJIAN_CENTRAL, target: 'tsmc-tainan-fab18', approachBearing: 105, formation: 'dispersed' },
        { id: 'w3', launchTimeMinutes: 60, droneSpec: 'shahed-136', count: 500, origin: FUJIAN_NORTH, target: 'tsmc-hsinchu-hq', approachBearing: 82, formation: 'concentrated' },
      ...
      seaLaunchedWaves: [],
      uuvDeployment: { count: 6, mineTargets: ['tsmc-hsinchu-hq', 'tsmc-kaohsiung'] },
      strategy: 'adaptive',
