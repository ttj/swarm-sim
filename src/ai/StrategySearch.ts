  ...
  return [
    // Attack A: 500 Shaheds, no jamming
    {
      ...
      redForce: {
        ...
        airWaves: [
          { id: 'w1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 300, origin: [119.3, 24.5] as [number, number], target: 'tsmc-hsinchu-hq', approachBearing: 90, formation: 'dispersed' },
          { id: 'w2', launchTimeMinutes: 15, droneSpec: 'shahed-136', count: 200, origin: [119.0, 23.5] as [number, number], target: 'tsmc-tainan-fab18', approachBearing: 110, formation: 'concentrated' },
        ],
      },
    },
    ...
    // Attack C: 1000 Shaheds multi-axis
    {
      ...
      redForce: {
        ...
        airWaves: [
          { id: 'w1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 400, origin: [119.3, 24.5] as [number, number], target: 'tsmc-hsinchu-hq', approachBearing: 85, formation: 'dispersed' },
          { id: 'w2', launchTimeMinutes: 10, droneSpec: 'shahed-136', count: 300, origin: [119.0, 23.5] as [number, number], target: 'tsmc-tainan-fab18', approachBearing: 105, formation: 'dispersed' },
    ...
    // Attack D: 2000 Shaheds + GPS jamming (hardest non-quarantine)
    {
      ...
      redForce: {
        ...
        airWaves: [
          { id: 'w1', launchTimeMinutes: 5, droneSpec: 'shahed-136', count: 500, origin: [119.3, 24.5] as [number, number], target: 'tsmc-hsinchu-hq', approachBearing: 88, formation: 'dispersed' },
          { id: 'w2', launchTimeMinutes: 10, droneSpec: 'shahed-136', count: 400, origin: [119.0, 23.5] as [number, number], target: 'tsmc-tainan-fab18', approachBearing: 105, formation: 'dispersed' },
